...
document.querySelector(".btn").addEventListener("click", function () {
  switch (Choise) {
    case 0:
      //console.log("BFS");
      document.querySelector(".Change-txt").innerHTML =
        "<p>Breath-First Search is <b>unweighted</b> and <b>gaurantee</b> the shortest path! </p>";
      BFS_traversal();
      break;
    ...
    case 1:
      // console.log("DFS");
      document.querySelector(".Change-txt").innerHTML =
        "<p>Dreath-First Search is <b>unweighted</b> and does not <b>gaurantee</b> the shortest path! </p>";
      DFS_traversal();
      break;
  ...
  for (let i = 0; i < rows; i++) {
    for (let j = 0; j < cols; j++) {
      ...
      if (dragging && flag == starting_vertex) {
        ...
        //in the queue color:greenish blue
        fill("#4de8f4");
        rect(j * w, i * h, w, h, 7, 7, 7, 7);
      } else if (states[k] == 3) {
        //after being processed from queue color:blue
        stroke("255");
        fill("#64c5ff");
        rect(j * w, i * h, w, h);
      } else if (states[k] == 7) {
...
function mousePressed() {
  if (mouseY >= 0 && mouseY <= height && mouseX >= 0 && mouseX <= width) {
    ...
    if (flag == starting_vertex || flag == destination_vertex) {
      //Cannot create wall at staring/ending node
      ...
      if (wall_arr[flag] == grid[y][x]) {
        // if press & there is already a wall make it back to normal
