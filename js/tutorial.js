  ...
  switch (Choise) {
    case 0:
      ...
      document.querySelector(".para").innerHTML =
        "<h1><b>Choose an algorithm from the dropdown menu<b></h1>";
    ...
    case 1:
      ...
      document.getElementById("tutorial-img").innerHTML = repImage;
      document.querySelector(".para").innerHTML =
        "<h1>Click the visualize button to visualize the following algorithm</h1>";
    ...
    case 2:
      ...
      document.getElementById("tutorial-img").innerHTML = repImage;
      document.querySelector(".para").innerHTML =
        "<h1><b>Adding walls</b></h1><br>Click on the grid to add wall and double click to remove wall<br>";
